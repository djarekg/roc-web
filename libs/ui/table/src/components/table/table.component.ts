...
import { type PageChange, TrackByPropertyDirective, type ViewModel } from '@roc-web/core';
...
export class TableComponent<T extends object> implements AfterViewInit, OnDestroy {
